...
URL_BACK = '/products/'
FIELDS = [
    Field(id='name', name='Название продукта'),
    Field(id='article', name='Название статьи'),
]


def interface_product_update(product: Product):
    ...
    header = header_get(text='Редактирование продукта', url_back=URL_BACK)
    widgets = [
        header,
    ]
