...
from app.database.models import Product, Parameter
...
def interface_parameter_update(parameter: Parameter):
    ...
    header = header_get(text='Редактирование вопроса', url_back=URL_BACK)
    widgets = [
        header,
    ]
